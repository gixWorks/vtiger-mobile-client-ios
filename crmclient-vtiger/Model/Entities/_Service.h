...
@property (nonatomic, readonly, strong) ServiceID* objectID;

@property (nonatomic, strong) NSNumber* crm_active;

@property (atomic) BOOL crm_activeValue;
...
@property (atomic) BOOL crm_crmondemandValue;
...
@interface _Service (AccountsCoreDataGeneratedAccessors)
...
@interface _Service (CampaignsCoreDataGeneratedAccessors)
...
@interface _Service (CommentsCoreDataGeneratedAccessors)
...
@interface _Service (ContactsCoreDataGeneratedAccessors)
...
@interface _Service (DocumentsCoreDataGeneratedAccessors)
...
@interface _Service (EnabledModulesCoreDataGeneratedAccessors)
...
@interface _Service (ErrorMessagesCoreDataGeneratedAccessors)
...
@interface _Service (GroupsCoreDataGeneratedAccessors)
...
@interface _Service (History_locationsCoreDataGeneratedAccessors)
...
@interface _Service (LeadsCoreDataGeneratedAccessors)
...
@interface _Service (ModulesCoreDataGeneratedAccessors)
...
@interface _Service (PotentialsCoreDataGeneratedAccessors)
...
@interface _Service (ProductsCoreDataGeneratedAccessors)
...
@interface _Service (SynctokensCoreDataGeneratedAccessors)
...
@interface _Service (TicketsCoreDataGeneratedAccessors)
...
@interface _Service (UsersCoreDataGeneratedAccessors)
