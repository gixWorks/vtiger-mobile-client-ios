...
extern const struct LeadFetchedProperties {
} LeadFetchedProperties;
...
@property int16_t lead_company_annualrevenueValue;
...
@property int16_t lead_company_noofemployeesValue;
...
@interface _Lead (CoreDataGeneratedAccessors)
