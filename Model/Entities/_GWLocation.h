...
extern const struct GWLocationFetchedProperties {
} GWLocationFetchedProperties;
...
@property double gw_latitudeValue;
...
@property double gw_longitudeValue;
...
@interface _GWLocation (CoreDataGeneratedAccessors)
