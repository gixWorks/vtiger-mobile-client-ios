...
extern const struct ModifiedRecordRelationships {
} ModifiedRecordRelationships;

extern const struct ModifiedRecordFetchedProperties {
} ModifiedRecordFetchedProperties;
...
@interface _ModifiedRecord (CoreDataGeneratedAccessors)
