...
extern const struct CRMFieldPicklistValueFetchedProperties {
} CRMFieldPicklistValueFetchedProperties;
...
@interface _CRMFieldPicklistValue (CoreDataGeneratedAccessors)
