...
extern const struct CampaignFetchedProperties {
} CampaignFetchedProperties;
...
@property int16_t crm_numsentValue;
...
@property int16_t crm_targetsizeValue;
...
@interface _Campaign (CoreDataGeneratedAccessors)
